...
%phi
subplot(2,3,4)
plot(time,rad2deg(f16_control_Euler.Data(:,1)),'r-','LineWidth',line_size )
hold on
set(gca,'FontSize',font_size)
...
%theta
subplot(2,3,5)
plot(time,rad2deg(f16_control_Euler.Data(:,2)),'r-','LineWidth',line_size )
hold on
set(gca,'FontSize',font_size)
...
%psi
subplot(2,3,6)
plot(time,rad2deg(f16_control_Euler.Data(:,3)),'r-','LineWidth',line_size )
hold on
set(gca,'FontSize',font_size)
...
hold on 
plot(time,f16_control_energy.Data(:,13),'r-','LineWidth',line_size )
hold on
set(gca,'FontSize',font_size)
grid on
...
hold on 
plot(time,f16_control_energy.Data(:,14),'r-','LineWidth',line_size )
hold on
set(gca,'FontSize',font_size)
grid on
...
hold on 
plot(time,f16_control_energy.Data(:,15),'r-','LineWidth',line_size )
hold on
set(gca,'FontSize',font_size)
grid on
...
hold on 
plot(time,f16_control_energy.Data(:,16),'r-','LineWidth',line_size )
hold on
hold on
set(gca,'FontSize',font_size)
grid on
...
%mach  
subplot(2,3,6)
plot(time,mach.Data(:),'r-','LineWidth',line_size )
hold on
set(gca,'FontSize',font_size)
grid on
...
hold on 
plot(time,f16_control_energy.Data(:,17),'r-','LineWidth',line_size )
hold on
set(gca,'FontSize',font_size)
grid on
...
hold on 
plot(time,f16_control_energy.Data(:,18),'r-','LineWidth',line_size )
hold on
set(gca,'FontSize',font_size)
grid on
...
hold on 
plot(time,f16_control_energy.Data(:,19),'r-','LineWidth',line_size )
hold on
set(gca,'FontSize',font_size)
grid on
% legend('\delta_{y_{c}}','\delta_{y}','FontSize',legend_size)
...
hold on 
plot(time,f16_control_energy.Data(:,20),'r-','LineWidth',line_size )
hold on
set(gca,'FontSize',font_size)
grid on
% legend('\delta_{z_{c}}','\delta_{z}','FontSize',legend_size)
...
% 
% subplot(5,2,1)
% plot(time,u_past(1:2001,1),'r-','LineWidth',line_size )
% hold on
% set(gca,'FontSize',font_size)
% grid on
% xlabel('Time(s)')
...
% 
% subplot(5,2,2)
% plot(time,u_past(1:2001,2),'r-','LineWidth',line_size )
% hold on
% set(gca,'FontSize',font_size)
% grid on
% xlabel('Time(s)')
...
% 
% subplot(5,2,3)
% plot(time,u_past(1:2001,3),'r-','LineWidth',line_size )
% hold on
% set(gca,'FontSize',font_size)
% grid on
% xlabel('Time(s)')
...
% 
% subplot(5,2,4)
% plot(time,u_past(1:2001,4),'r-','LineWidth',line_size )
% hold on
% set(gca,'FontSize',font_size)
% grid on
% xlabel('Time(s)')
...
% 
% subplot(5,2,5)
% plot(time,u_past(1:2001,5),'r-','LineWidth',line_size )
% hold on
% set(gca,'FontSize',font_size)
% grid on
% xlabel('Time(s)')
...
% 
% subplot(5,2,7)
% plot(time,u_past(1:2001,6),'r-','LineWidth',line_size )
% hold on
% set(gca,'FontSize',font_size)
% grid on
% xlabel('Time(s)')
...
% 
% subplot(5,2,8)
% plot(time,u_past(1:2001,7),'r-','LineWidth',line_size )
% hold on
% set(gca,'FontSize',font_size)
% grid on
% xlabel('Time(s)')
...
% 
% subplot(5,2,9)
% plot(time,u_past(1:2001,8),'r-','LineWidth',line_size )
% hold on
% set(gca,'FontSize',font_size)
% grid on
% xlabel('Time(s)')
...
% 
% subplot(5,2,1)
% plot(time,f16_control_energy.Data(:,2),'r-','LineWidth',line_size )
% hold on
% set(gca,'FontSize',font_size)
% grid on
% xlabel('Time(s)')
...
% 
% subplot(5,2,2)
% plot(time,f16_control_energy.Data(:,3),'r-','LineWidth',line_size )
% hold on
% set(gca,'FontSize',font_size)
% grid on
% xlabel('Time(s)')
...
% 
% subplot(5,2,3)
% plot(time,f16_control_energy.Data(:,4),'r-','LineWidth',line_size )
% hold on
% set(gca,'FontSize',font_size)
% grid on
% xlabel('Time(s)')
...
%--------------------------------------------------------------------------
figure (9)
u_1 = ControlAllocationMode.Data;
plot(time,u_1)
